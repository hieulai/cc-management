...
Item.create ([{name: "Custom Shower Pan", description: "Labor & Materials: Build custom shower pan.", unit: each, cost: 450, margin: 75},
              {name: "Frisae Carpet", description: "Labor & Materials: Install frisae style carpet.", unit: sf, cost: 1.85, margin: .50},
              ...
              {name: "2x4x9 Stud", description: "Materials: 9ft-2x4 studs", unit: each, cost: 2.53, margin: .20},
              {name: "1/2 OSB Subflooring", description: "Materials: 4x8 sheets of 1/2in T&G OSB Subflooring", unit: each, cost: 13.78, margin: .50},
