            ...
            **/            
            ...
            .then($.proxy(function () {
                ...
                if(this.input.error) {
                    ...
                    this.value = $(this.options.scope).hasClass("currency") ? Shared.text_to_number(this.value) : this.value
    ...
    AbstractInput.prototype = {
       ...
       **/
       value2html: function(value, element) {
           value = $(element).hasClass("currency") ? Shared.number_to_currency(value, 2, '.', ',') : value;
