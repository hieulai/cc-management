class DepositsReceipt < ActiveRecord::Base
  ...
  def charge_account_and_update_receipt
    ...
    self.deposit.builder.deposits_held_account.update_attribute(:balance, self.deposit.builder.deposits_held_account.balance.to_f - self.amount.to_f)
  ...
  def refund_account_and_update_receipt
    self.deposit.builder.deposits_held_account.update_attribute(:balance, self.deposit.builder.deposits_held_account.balance.to_f + self.amount_was.to_f)
